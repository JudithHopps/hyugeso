<template>
  <div>
    카테고리 :
    <select name="" id="selectRoute" v-model="selectedHighway" @change="changeSelect">
      <option
    ...
    <select name="" id="selectRest" v-model="selectedRestarea" @change="changeSelect">
      <option
        v-for="rest in selectedrestList"
        :value="rest.svarNm"
        :key="rest.svarNm"
      >
        {{ rest.svarNm }}
...
const highwayDataDeduplicationArray: HighwayData[] = removeDuplicates(highwayDataArray, 'routeNm');
